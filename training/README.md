...
- **결론: 14M 의 용량 벽은 라벨 품질(소프트 라벨)로 넘을 수 없다.** 110M 의 우위는
  지식 전달이 아니라 파라미터에서 나온다는 것이 대조 실험으로 확정됐다. 출시 모델은
  r5 유지, 110M P1-A 는 출시 후 교체 후보 유지. FF-4(14M 재학습 금지) 재봉인 —
  34차 추인 대기. 중간 체급(klue/roberta-small 68M — train.py 주석의 예비 후보)은
  새 사전 등록 안건으로만 열 수 있다
