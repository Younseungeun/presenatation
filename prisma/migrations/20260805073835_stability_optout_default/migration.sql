...
INSERT INTO "new_PredictionCard" ("assetClass", "assetName", "baseMode", "basePrice", "confidence", "createdAt", "currency", "deadline", "direction", "id", "reportId", "selfProfitability", "selfStability", "targetType", "targetValue", "ticker", "withdrawnAt") SELECT "assetClass", "assetName", "baseMode", "basePrice", "confidence", "createdAt", "currency", "deadline", "direction", "id", "reportId", "selfProfitability", "selfStability", "targetType", "targetValue", "ticker", "withdrawnAt" FROM "PredictionCard";
