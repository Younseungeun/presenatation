...
CREATE TABLE "new_PredictionCard" (
    ...
    "selfStability" INTEGER NOT NULL DEFAULT 5,
    "selfProfitability" INTEGER NOT NULL DEFAULT 5,
...
INSERT INTO "new_PredictionCard" ("assetClass", "assetName", "baseMode", "basePrice", "confidence", "createdAt", "currency", "deadline", "direction", "id", "reportId", "targetType", "targetValue", "ticker", "withdrawnAt") SELECT "assetClass", "assetName", "baseMode", "basePrice", coalesce("confidence", 5) AS "confidence", "createdAt", "currency", "deadline", "direction", "id", "reportId", "targetType", "targetValue", "ticker", "withdrawnAt" FROM "PredictionCard";
