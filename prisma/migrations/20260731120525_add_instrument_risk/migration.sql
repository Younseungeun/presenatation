...
INSERT INTO "new_Instrument" ("active", "assetClass", "currency", "id", "name", "shortable", "source", "syncedAt", "ticker") SELECT "active", "assetClass", "currency", "id", "name", "shortable", "source", "syncedAt", "ticker" FROM "Instrument";
