...
/**
 * 생체 인증 — 지문. 다리 달린 돔 능선 셋 + 코어 심.
 * 첫 안이 무지개로 읽혀 다시 그렸다. 열쇠는 다리 — 각 능선이 아래에서 멈추지 않고
 * 옆으로 곧게 내려온다(무지개엔 다리가 없고 지문엔 있다). 다리 길이를 계단식(7.5/5.2/2.8)으로
 * 겹쳐 Touch ID 소용돌이가 되고, 안쪽에 코어 심이 선다. 폭보다 높아(15×16) 손끝으로 읽힌다.
 * 세트에서 유일하게 채운 덩어리가 없다(지문은 능선). 획 1.8로 무게를 지킨다.
 */
  ...
  return (
    <svg {...BOX}>
      <g
        ...
        strokeLinecap="round"
      >
        <path d="M5.4 17.5 V10 A6.6 6.6 0 0 1 18.6 10 V17.5" />
        <path d="M7.6 16.8 V11.6 A4.4 5 0 0 1 16.4 11.6 V16.8" />
        <path d="M9.6 16 V13.2 A2.4 3.4 0 0 1 14.4 13.2 V16" />
        <path d="M12 14.6 V9.6" />
      </g>
    </svg>
  );
}
