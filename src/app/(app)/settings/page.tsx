  ...
  return (
    <>
      ...
      <main className={styles.page}>
        ...
        <div className={styles.list}>
          {/* 문의는 **막힌 사람이 찾는 것**이라 설정의 첫 줄에 둔다. 약관 아래에 두면
              정작 급한 사람(정산이 동결됐다, 계좌가 안 붙는다)이 못 찾는다 */}
          <Row
            href="/settings/notifications"
            label="알림"
            sub="이 기기로 알림 받기 — 판정·환불·계좌 변경"
          />
          <Row
            href="/support"
            label="문의하기"
            sub="정산·계좌·로그인 — 주제를 고르면 안내가 먼저 나옵니다"
          />
        ...
        {user?.role === "OPERATOR" && (
          <>
            ...
            <div className={styles.list}>
              ...
              <Row href="/admin/compliance?tab=inst" label="판정 보류 큐" sub="수동 판정 대기 카드" />
