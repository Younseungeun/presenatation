 ...
 * 문항을 전부 늘어놓고 각각에 [격리] 버튼을 달면, 그건 막고 싶었던 짓("학생이 틀리는
    ...
    >
      ...
      {notYetEvidence && (
        <div className={a.note}>
          ...
          학생이 못 배운 쪽에 가까우니 재학습에 넣으십시오. 다른 모델에서도 떨어지면 그때
          격리 후보로 올라옵니다.
        </div>
      )}
  ...
  return (
    <div style={{ marginTop: 8 }}>
      <div className={`${a.note} ${a.noteWarn}`}>
        ...
        다음 재학습부터 이 문항으로는 학생을 시험하지 않습니다. 기록(누가·언제·왜)은 남습니다.
        <br />
        <br />
        <b>문항이 잘못 쓰였을 때만</b> 격리하십시오 — 학생이 못 배운 것이라면 여기서 뺄 것이
        아니라 재학습에 넣어야 합니다.
      </div>
