 ...
 * 재학습 신호 계기판 — **숫자 하나뿐이다.**
 *
 * 재는 것은 "학생의 판단과 운영자의 최종 판정이 엇갈린 건수"이고, 그 수가 문턱에
 ...
 * 엇갈림은 두 가지에서 같은 값을 올린다: 학생이 틀렸을 때와, **운영자가 실수했는데
 * 학생이 맞았을 때**. 운영자 실수를 그대로 학습시키면 학생이 실수를 배운다. 그래서
    ...
    >
      ...
      {reached ? (
        <div>
          ...
          이 표본에는 <b>학생이 틀린 건</b>과 <b>운영자가 실수했는데 학생이 맞은 건</b>이 섞여
          있습니다. 가리지 않고 학습시키면 학생이 운영자의 실수를 배웁니다.
        </div>
      ) : (
        <div>
