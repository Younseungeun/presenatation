...
import { ArgosDetail } from "./ArgosDetail";
...
export default async function ArgosPage() {
  ...
  return (
    <>
      <AdminHead title="검수 상세" sub="정확도 · ARGOS · 검수 규칙" backHref="/admin/compliance" />
      <main className={a.page}>
        ...
        {/* 제목과 상태 칩은 ArgosDetail 이 함께 그린다 — 상태를 아는 쪽이 제목도 쓴다
            (2026-08-23 창업자 지시로 물음표를 걷고 그 자리에 근무/결근 칩을 놓음) */}
        <ArgosDetail />

        {/* **ARGOS 순이익** — 계기판에서 이리로 내려왔다 (2026-08-29 창업자 지시).
