 ...
 *
 * 24시간인 근거는 **운영 리듬**이다. 판정 배치는 시장 마감 직후 하루 한 번 돌고,
 * 잘못된 판정이 드러나는 경로(구매자 이의·리서처 문의·운영자 아침 확인)는 전부
 * 그다음 하루 안에 있다. 48시간으로 늘리면 탐지력은 거의 그대로인데 정상 건의
 * 대기만 두 배가 된다.
 */
export const SETTLEMENT_COOLDOWN_HOURS = 24;
