...
// 이용자가 신고하면, 운영자 검토로 확인된 신고에 한해 선착순으로 리포트 구매 쿠폰을 지급.
//  · 보상은 반드시 운영자 검토(CONFIRMED) 후 — 오신고에 보상이 나가는 일이 없게
//  · 무고 방어: 하루 신고 한도 + 기각 사유 기록(반복 무고 제재 근거)
//  · 쿠폰은 무상 지급 할인권 — 대가 없이 발행되어 선불전자지급수단 규제 대상이 아니다
...
/**
 * 운영자 검토 — 확인이면 선착순 쿼터 안에서 보상(쿠폰) 대상으로 표시하고 신고자에게 알림.
      ...
      data: {
        ...
        body:
          input.decision === 'CONFIRMED'
            ? rewarded
              ? '신고하신 내용이 확인되었습니다. 리포트 구매에 쓸 수 있는 쿠폰이 지급될 예정입니다. 클린 리서치에 함께해 주셔서 감사합니다.'
              : '신고하신 내용이 확인되었습니다. 아쉽게도 보상 선착순이 마감되어 쿠폰은 지급되지 않지만, 조치에 반영되었습니다.'
