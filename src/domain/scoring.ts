...
// 점수 산정 v5 — 정보량(로그 점수) 모델 (2026-08-13 확정. 등급의 유일한 기준)
//
...
// v5로 바꾼 뒤 두 분포의 꼬리가 겹치지 않는다(준수형 p5 +177 / 스팸 p95 −30).
...
// 벌어졌다. 그래서 집계는 **domain/evidence.ts의 clusterEvidence**를 거친다.
//
